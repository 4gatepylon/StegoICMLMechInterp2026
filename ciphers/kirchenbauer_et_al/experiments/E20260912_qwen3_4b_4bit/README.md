...
that budget, global batch 128 (documents per optimizer step), delta 2, and
256 optimizer steps. This uses
...
Checkpoints: `$STEGO_ARTIFACTS_DIR/qwen3-4b-4bit-fineweb-prefix-kl-lora/`.
