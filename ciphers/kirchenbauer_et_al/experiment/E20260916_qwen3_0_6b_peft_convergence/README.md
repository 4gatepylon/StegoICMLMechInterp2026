...
data-token budget fixed. The folder retains the original experiment name.
...
3e-4, loss `nll`, alpha 1, delta 2). Each processes 536,870,912 padded data
positions over 4,096 optimizer steps, plus prefix overhead. On one GPU, accumulation is 16; on multiple
